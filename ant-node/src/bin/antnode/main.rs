...
use crate::node_rpc::{NodeCtrl, StopResult};
...
struct Opt {
    ...
    ///
    /// By default, the node will verify that it is externally reachable before starting.
    /// Use this flag to skip this check (useful for local testing or when you know the
...
) -> Result<Option<(PathBuf, u16)>, ant_node::Error> {
