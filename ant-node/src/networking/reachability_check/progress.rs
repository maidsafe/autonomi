...
use super::MAX_WORKFLOW_ATTEMPTS;
...
mod tests {
    use super::*;
    use crate::networking::reachability_check::dialer::DialManager;
    ...
    #[tokio::test]
    async fn test_workflow_boundaries() {
        let calculator = ProgressCalculator::new();

        // Test workflow 1 with no attempts (should be 1)
        let dial_manager = create_mock_dial_manager(1, HashMap::new(), HashMap::new());
        ...
        let dial_manager = create_mock_dial_manager(2, HashMap::new(), HashMap::new());
        let progress = calculator.calculate_progress(&dial_manager);
        ...
        let dial_manager = create_mock_dial_manager(5, HashMap::new(), HashMap::new());
        let progress = calculator.calculate_progress(&dial_manager);
    ...
    #[tokio::test]
    async fn test_individual_progress_calculations() {
        let calculator = ProgressCalculator::new();
