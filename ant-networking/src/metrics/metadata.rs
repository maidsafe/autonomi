...
impl<'a> MetadataRecorder<'a> {
    ...
    pub fn new(registries: &'a mut MetricsRegistries) -> Self {
    ...
    pub fn register_peer_id(&mut self, peer_id: &PeerId) {
    ...
    pub fn register_identify_protocol_string(&mut self, identify_protocol_str: String) {
        self.metadata_sub_reg.register(
    ...
    pub fn register_reachability_status(&mut self, status: Option<ReachabilityStatus>) {
    ...
    pub fn register_reachability_check_is_ongoing(&mut self) {
        self.metadata_sub_reg.register(
